...
description: One line that shows in listings and search results.
---
...
Optional front matter flags:
  pin: true        stick to top of home page
  mermaid: true    enable ```mermaid diagram blocks
  math: true       enable LaTeX
